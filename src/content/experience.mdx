### Full Stack Developer at <a href="https://unlockd.finance/"><u><em>Unlockd</em></u></a>

date: November 2023 - now

 - Conducted in-depth research on the latest decentralized finance (DeFi) trends.
 - Specialized in enhancing web3 security measures within the Unlockd Finance ecosystem.
 - Contributed to the development of highly profitable yield farming vaults in the innovative MaxAPY protocol.
 - Implemented cutting-edge strategies with a focus on achieving high Annual Percentage Rates (APR) to outperform competitors in the market.
 - Programmed and optimized strategies for yield farming vaults, incorporating leading DeFi protocols such as Curve, Uniswap, Convex, Yearn, among others.
