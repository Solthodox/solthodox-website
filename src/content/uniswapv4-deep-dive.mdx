...
- [v4-periphery](https://github.com/Uniswap/v4-periphery): meant to be used by
  developers other develpers who want to implement or innovate on top of the
  protocol.
...
through the utilization of an _ERC1155_ token, ensuring seamless functionality.
